...
def _run_analysis_thread(family_name: str, variant_name: str, force_refresh: bool = False) -> None:
    ...
    try:
        ...
        # Regenerate variant_summary.json and variant_registry.json from the
        # warehouse tables. The summary assembler is transformer-specific (it reads
        # the modulo-addition outcome clusters); skip it for other families.
